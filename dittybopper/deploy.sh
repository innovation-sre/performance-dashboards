...
export DASHBOARDS="chaos-dashboard-general.json chaos-dashboard-workload.json ocp-performance.json api-performance-overview.json etcd-on-cluster-dashboard.json"
